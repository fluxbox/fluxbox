...
1 嚴重：記憶體不足，無法配置給 EWMH 客戶端清單

$set 6 #FbTkError

1 警告！高度>3200, 設定高度=3200
2 警告！寬度>3200, 設定寬度=3200
3 警告：無法載入權宜字型
4 配額錯誤。
5 建立像素對映時發生錯誤
6 無法建立 XImage
...
1 BScreen::BScreen：向 X 伺服器查詢時發生錯誤。\n	 螢幕中已經執行另外的視窗管理員
2 W: %4d x H: %4d
3 BScreen::BScreen：管理螢幕 %d 是使用視訊 0x%lx、色深 %d\n
4 W: %04d x H: %04d
...
1 錯誤：必須指定下列之一：-solid、-mod、-gradient\n
2 無法建立像素對映元素，放棄！
3 -display <string>       顯示連接\n\
-mod <x> <y>             模塊式樣\n\
