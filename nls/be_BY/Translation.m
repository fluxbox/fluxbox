...
2 W: %4d x H: %4d
3 W: 0000 x H: 0000
4 BScreen::BScreen: кіраваньне экранам %d карыстаючыся visual 0x%lx, глыбіня %d\n
5 X: %4d x Y: %4d
6 0: 0000 x 0: 0000
...
-display <string>        Злучэньне з дысплэям\n\
...
-help\t\t\t\tнадрукаваць гэты тэкст ды выйсьці.\n\n
13 увага: немагчыма прызначыць пераменную асяродку 'DISPLAY'
